...
**Skill:** `[SKILL]` (Phases 1–5), with `[SKILL]` run as the Phase 4 self-review in a
...
## 4. The contract ([TARGETS_DOC]) — PROVISIONAL
...
`[SKILL]` was run in a fresh context that had not created the design, against the contract
